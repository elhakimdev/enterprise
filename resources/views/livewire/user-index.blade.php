    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                    <h3 class="block-title">List All User</h3>
                        ...
                        <table class="table table-borderless table-striped table-vcenter">
                            ...
                            <tr>
                                ...
                                <td class="d-none d-xl-table-cell font-size-sm">
                                        <a class="font-w600">{{$user->email}}</a>
                                </td>
                                <td>
                                        <span class="font-size-sm font-w600 px-2 py-1 rounded  bg-success-light text-success">{{$user->roles->pluck('name')}}</span>
                                </td>
                                <td class="d-none d-sm-table-cell text-center">
                                        <span class="font-size-sm font-w600 px-2 py-1 rounded bg-body-dark">{{$user->created_at->diffForHumans()}}</span>
                                </td>
